...
export default function VolleyLeft() {
  ...
  const handleSearch = async () => {
    const res = axios.get(
      `https://v1.volleyball.api-sports.io/teams?search=${debounceSearch}`,
      {
        headers: {
  ...
  const handleDefaultTeams = async () => {
    const res = axios.get(
      `https://v1.volleyball.api-sports.io/teams?league=${majorLeagueId.NBA}&season=${season}`,
      {
        headers: {
          "x-apisports-key ": xxxKey,
        },
